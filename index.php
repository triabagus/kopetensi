              ...
              <div class="col">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4"><i class="fas fa-user-graduate"></i> Login</h1>
                  </div>
                  <?php
                      $user = new sign();
                  ...
                  <form class="user" action="" method="post" name="login">
                    ...
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" id="inputPassword2" placeholder="Password" name="password" required>
                    </div>
                    <button onclick="return(submitLogin());" type="submit" class="btn btn-primary btn-user btn-block" name="submit">
                      Login
                    </button>
                  </form>
